    ...
    Hfs = class {
      ...
      async *walk(dirPath, { directoryFilter = () => true, entryFilter = () => true } = {}) {
        ...
        const walk = (async function* (dirPath2, { directoryFilter: directoryFilter2, entryFilter: entryFilter2, parentPath = "", depth = 1 }) {
          let dirEntries;
          try {
            dirEntries = await __privateMethod(this, _Hfs_instances, callImplMethodWithoutLog_fn).call(this, "list", dirPath2);
          } catch (error) {
...
//# sourceMappingURL=src-2KAAB46I.js.map
